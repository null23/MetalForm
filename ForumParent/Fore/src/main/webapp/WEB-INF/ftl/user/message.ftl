          ...
          <#list pagehelper.list as reply>
            <li data-id="123">
              <blockquote class="layui-elem-quote">
                <a href="/jump?username=Absolutely" target="_blank"><cite>${reply.getUser().name}</cite></a>回答了您的帖子
                  <a href="../post/showpost.action?postID=${reply.getPost().id}">${reply.getPost().title}</a>
                  说：${reply.content}
                  <br>
