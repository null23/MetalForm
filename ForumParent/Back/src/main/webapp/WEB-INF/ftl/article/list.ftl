            ...
            <div class="layui-form" style="line-height: 10px;">
                <table class="layui-table">
                    ...
                    <tr>
                        ...
                        <td>${var.date?string('yyyy-MM-dd HH:mm:ss')}</td>
                        <td>
                            <button class="layui-btn layui-btn-danger layui-btn-small btn-my-del" del-id="del('${var.id}');" del-name=" '${var.title}' " title="删除">
                                <i class="layui-icon">&#xe640;</i>
                            </button>
                            <a href="showarticle.action?newsID=${var.id}"><button class="layui-btn layui-btn-danger layui-btn-small btn-my-del" del-id="del('${var.id}');" del-name=" '${var.title}' " title="查看">
                                <i class="layui-icon">&#xe617;</i>
                            </button></a>
                        </td>
                    </tr>
