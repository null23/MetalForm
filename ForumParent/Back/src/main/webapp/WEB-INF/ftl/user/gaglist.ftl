        ...
        <div class="layui-main">
            ...
            <div class="layui-form" style="line-height: 10px;">
                <table class="layui-table">
                    ...
                    <tr>
                        <td><input type="checkbox" name="gid" id="${var.id}" lay-skin="primary" lay-filter="checkOne"></td>
                        <td>${var.getUser().name}</td>
                        <td>
                            <a href="updategag.action?gid=${var.id}"><button class="layui-btn layui-btn-danger layui-btn-small btn-my-del" del-id="del('');" del-name=" '' " title="查看">
...
<script>
    ...
    layui.use(['form', 'element', 'laypage', 'layer'], function() {
        ...
        laypage({
            ...
            if(!first){
                window.location.href='postlist.action?pageNum='+obj.curr;
            }
        }
        });
        //ȫѡ
